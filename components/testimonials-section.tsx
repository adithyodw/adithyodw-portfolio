      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto pb-8">
            Trusted by enterprise clients and professional partners across Singapore and Asia-Pacific.
          </p>
        </div>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  Adithyo brings rare depth across both technical architecture and business strategy. His pre-sales solutions consistently win enterprise deals because they&apos;re engineered to solve real problems — not just check boxes. One of the most thorough solutions architects I&apos;ve worked with in APAC.
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Enterprise Technology Partner</div>
                  <div className="text-gray-600 text-sm md:text-base">Fortune 500 Technology Client, Singapore</div>
                </div>
              </div>
            </div>
